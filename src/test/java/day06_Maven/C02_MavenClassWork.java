...
//         Pay Bills sayfasına gidin
         driver.findElement(By.xpath("//strong[.='Online Banking']")).click();//online banking linkine tikladik
         driver.findElement(By.id("pay_bills_link")).click();//paybill linkini tikladik//Note burada id yerine XPATH yaparak da olurdu
